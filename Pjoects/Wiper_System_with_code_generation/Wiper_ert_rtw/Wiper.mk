###########################################################################
## Makefile generated for component 'Wiper'. 
## 
## Makefile     : Wiper.mk
## Generated on : Mon Dec 11 17:56:44 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Wiper.elf
...
START_DIR                 = C:/Users/Beshary/Desktop/MBD_OS_DEV/Git_hub_Project/Wiper_System_with_code_generation
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/Beshary/DOCUME~1/MATLAB/R2023b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Wiper.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=10000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Wiper -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Wiper.o Wiper_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Wiper_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Wiper_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
Wiper.o : $(START_DIR)/Wiper_ert_rtw/Wiper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Wiper_data.o : $(START_DIR)/Wiper_ert_rtw/Wiper_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Wiper_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
