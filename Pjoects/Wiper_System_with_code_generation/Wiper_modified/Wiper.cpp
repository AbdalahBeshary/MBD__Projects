...
void Wiper_step(void)
{
  ...
  switch (rtU.Wiper_Mode_of_Operation) {
   ...
   case Auto:
    ...
    if (rtU.Rain_Sensor_Error != 0.0) {
      ...
      rtb_MultiportSwitch = 0.00390625 * look1_binlx(rtU.Rain_Density,
   ...
   */
  rtb_Add = 0.7 * rtb_MultiportSwitch + 0.3 * rtDW.UnitDelay_DSTATE;
  ...
  /* Outport: '<Root>/Wiper_indcation' */
  rtY.Wiper_indcation = rtb_MultiportSwitch;
}
